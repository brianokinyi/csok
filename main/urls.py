...
urlpatterns = [
    ...
    re_path(r'^reset-password/$', auth_views.password_reset, {
        ...
        'email_template_name': 'main/reset_password_email.html'}, name='password_reset'),

    re_path(r'^reset-password/done/$', auth_views.password_reset_done, {
        'template_name': 'main/reset_password_done.html'}, name='password_reset_done'),
    ...
    re_path(r'^reset-password/complete/$', auth_views.password_reset_complete, {
        'template_name': 'main/reset_password_complete.html'}, name='password_reset_complete'),
