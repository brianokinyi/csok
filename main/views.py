...
def edit_profile(request):
    ...
    if request.user.is_authenticated and request.user.pk == user.pk:
        ...
        return render(request, 'main/change_profile.html', args)
...
class AccountListView(generic.ListView):
    template_name = 'main/account_list.html'
...
class AccountDetail(generic.DetailView):
    model = Account
    page_template = "main/account_detail.html"
...
class PostDetailView(DateDetailView):
    ...
    month_format = '%m'
    page_template = "main/post_detail.html"
...
def borrow_loan(request):
    return render(request, 'main/borrow_loan.html')
